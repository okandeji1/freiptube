                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" placeholder="Video Title" id="e1 title"
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="3" id="e2 description" name="description" class="form-control :class="
                                        { 'is-invalid' : form.errors.has('description') }">Description</textarea>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <select id="e3 category" name="category" class="custom-select :class=" { 'is-invalid' :
                        ...
                        <div class="row category-checkbox">
                            ...
                            <div class="col-lg-2 col-xs-6 col-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="video" class="form-control :class=" { 'is-invalid' :
                                        form.errors.has('video') }" id="e8 video">
